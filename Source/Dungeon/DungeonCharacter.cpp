...
void ADungeonCharacter::Interact()
{
	...
	DrawDebugSphere(GetWorld(), End, InteractionSphereRadius, 25, FColor::Blue, false, 5.0f);
	DrawDebugSphere(GetWorld(), Start, InteractionSphereRadius, 25, FColor::Green, false, 5.0f);
	...
	{
		UE_LOG(LogTemp, Display, TEXT("Shape Trace Hit Nothing"));
	}
